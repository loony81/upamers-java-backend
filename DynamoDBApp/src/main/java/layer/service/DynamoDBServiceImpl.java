...
public class DynamoDBServiceImpl implements DynamoDBService {
    ...
    public String updateUser(Map<String, String> pathParameters, String inputBody) {
        ...
        */
        User newUser = new Gson().fromJson(inputBody, User.class);

        User existingUser = dynamoDBMapper.load(User.class, newUser.getEmail());
        if (existingUser != null) {    
            if (isValidSocialMedia(newUser.getSocialMedia())) {
                updateUsersNotNullAttributes(existingUser, newUser);
